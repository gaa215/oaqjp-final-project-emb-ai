...
from emotion_detection import emotion_detector  # Import the emotion detector function
...
def sent_detector():
    ...
    This function retrieves the input text from the request, processes it using the 
    emotion detector function, and returns a JSON response containing emotion scores.
